...
// CanvasFragment (your ‘details’ fragment).
// the CanvasFragment will have the ability to change its background color.
    //CanvasFragment is replacing CanvasActivity
public class CanvasFragment extends Fragment {
    ...
    //relative layout is full screen layout
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view=  inflater.inflate(R.layout.fragment_canvas, container, false);
        ...
        txtColorName=view.findViewById(R.id.txtColor);
        txtColorName.setText(colorActivity.colorChoice);
        //txtColorName.setText(colorActivity.colorName);
        relativeLayout.setBackgroundColor(Color.parseColor(colorActivity.colorChoice));
